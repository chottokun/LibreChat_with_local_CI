...
RCE_DATA_DIR_INTERNAL = Path(os.environ.get("RCE_DATA_DIR_INTERNAL", "/app/shared_volumes/sessions"))
...
if RCE_DATA_DIR_HOST:
    try:
        RCE_DATA_DIR_INTERNAL.mkdir(parents=True, exist_ok=True)
